 ...
 * @author John Dave
 */
public class panel8a extends javax.swing.JFrame {

    /**
     * Creates new form panel8a
     */
    public panel8a() {
        initComponents();
         }
    ...
    public void connect(){
     try{   Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");
            String path = "C:\\Users\\John Dave\\Documents\\NetBeansProjects\\Gradedatabase1.accdb";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "subject", "1st quarter", "2nd quarter", "final grade"
            }
        ));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtAVE, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    grade = "Failed"; // Add a default grade if none of the conditions match
}
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       if(jTextField1.getText().equals("")||jTextField3.getText().equals("")||jTextField5.getText().equals("")||txtAVE.getText().equals(""))
        {
            JOptionPane.showMessageDialog(this, "Please Input All Data in the Field");
        }
        else
        {
            String data[] = {jTextField1.getText(),jTextField3.getText(),jTextField5.getText(),txtAVE.getText()};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(panel8a.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
